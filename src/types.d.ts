export type Category = "audio-server" | "audio-app" | "embedded" | "fpga" | "linux-audio" | "ai-tools" | "dev-tools";
export type ArtType = "chip" | "fpga" | "optical" | "clock" | "bus" | "network" | "terminal" | "scope" | "tdm" | "eurorack" | "wavetable" | "location" | "midi" | "visual" | "logo" | "auto";
